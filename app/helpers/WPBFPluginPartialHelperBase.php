...
class WPBFPluginPartialHelperBase {
	/**
	 * @var null|WPBFPluginPartialHelperBase
	 */
	...
	/**
	 * @return WPBFPluginPartialHelperBase|null
	 */
	public static function get_instance() {
		if ( null === self::$instance ) {
			self::$instance = new WPBFPluginPartialHelperBase();
		}
	...
	public function get_partial_path( $partial, $folder ): string {
		...
		$file_path   = WPBFMP_LOCAL_PLUGIN_PATH . DIRECTORY_SEPARATOR . $folder_path . DIRECTORY_SEPARATOR . $partial . '.php';
